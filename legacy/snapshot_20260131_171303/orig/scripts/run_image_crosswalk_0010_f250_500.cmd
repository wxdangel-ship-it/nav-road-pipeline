...
set "OUT_RUN=runs\image_crosswalk_%DRIVE_TAG%_%FRAME_START%_%FRAME_END%_%TS%"
...
echo [IMAGE_CROSSWALK] outputs: %OUT_RUN%\outputs

echo [IMAGE_CROSSWALK] report: %OUT_RUN%\outputs\crosswalk_stage2_report.md

echo [IMAGE_CROSSWALK] trace: %OUT_RUN%\outputs\crosswalk_trace.csv

echo [IMAGE_CROSSWALK] qa_index: %OUT_RUN%\outputs\qa_index_wgs84.geojson
